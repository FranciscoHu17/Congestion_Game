...
export default class Level4 extends GameLevel{
    ...
    loadScene(): void {
        ...
        this.load.tilemap("maplevel4", "assets/tilemaps/level4.json");
    ...
    startScene(): void {
        ...
        this.add.tilemap("maplevel4", new Vec2(1, 1));

        this.viewport.setBounds(0, 0, 1000*128, 1000*128);

        this.playerSpawn = new Vec2(3*128, 123*128);
    ...
    updateScene(deltaT: number): void {
        ...
        if(this.currPlayer.position.y > 128*128){
            this.respawnPlayer();
        }
    }
}